...
//Variable D (diagonal), S (factor d'escalat) i d (diagonal cub 1.75) de la fórmula d'escalatge d'objectes per a ortogràfica
	GLdouble D;
	GLdouble S;
	GLdouble d;

//Variables Pràctica 3 robot 
...
//	afx_msg void OnUpdateObjecteTexteSTROKE(CCmdUI* pCmdUI);
	...
	afx_msg void OnUpdateObjecteCmo(CCmdUI* pCmdUI);
	afx_msg void OnObjecteCamio32876();
	afx_msg void OnUpdateObjecteCamio32876(CCmdUI* pCmdUI);
	afx_msg void OnObjecteAvio();
	afx_msg void OnUpdateObjecteAvio(CCmdUI* pCmdUI);
	...
	afx_msg void OnBxmenys();
	afx_msg void OnBxmes();
	afx_msg void OnBxmmenys();
	afx_msg void OnBxmmes();
	afx_msg void OnBymenys();
	afx_msg void OnBymes();
	afx_msg void OnBzmenys();
	afx_msg void OnBzmes();
	afx_msg void OnBzmmenys();
	afx_msg void OnBzmmes();
};
